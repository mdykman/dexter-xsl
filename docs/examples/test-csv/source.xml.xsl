...
<!-- generated by dexter-0.9-beta (copyright (c) 2007-2010 Michael Dykman, Lauren Enterprises) from `source.xml'  -->
</xsl:preserve-space>
...
<xsl:if test="string-length(data/names)">
<xsl:call-template name="csv">
<xsl:with-param name="param1" select="data/names"/>
</xsl:call-template>
</xsl:if>
<xsl:text>
	</xsl:text>
