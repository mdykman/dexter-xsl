  ...
  private class CkBkListTemplParam extends CkBkTemplParam
  {
    ...
    */
    ...
    public void validate() throws TransformerConfigurationException
    {
        ...
        {
          processParam(temp, new StringBuilder("")) ;
        }
    }
    ...
    private void processParam(StringBuilder prefix, StringBuilder expr)
    {
      if (expr.length() == 0)
      {
    ...
    private void processParamExpr(StringBuilder prefix, StringBuilder expr)
    {
        int ii = 0 ;
        int len = expr.length() ;
