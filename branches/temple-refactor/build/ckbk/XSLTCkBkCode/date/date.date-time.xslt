...
<xsl:template name="format-mysql-date">
	<xsl:param name="param1"/>
<!--  2009-04-10 11:52:51 -->
</xsl:template>

<xsl:template mode="date-format" name="date:format-date-time">
	<xsl:param name="year"/>
  ...
  <xsl:template mode="date-format" name="date:calculate-day-of-the-week">
  ...
  <xsl:template mode="date-format" name="date:get-day-of-the-week-name">
  ...
  <xsl:template mode="date-format" name="date:get-day-of-the-week-abbreviation">
    <xsl:param name="day-of-the-week"/>
  ...
  <xsl:template mode="date-format" name="date:get-month-name">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
  ...
  <xsl:template mode="date-format" name="date:get-month-abbreviation">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
  ...
  <xsl:template mode="date-format" name="date:date-to-julian-day">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="year" select="substring-before($date,'-')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
  ...
  <xsl:template mode="date-format" name="date:julian-date-to-julian-day">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="year" select="substring-before($date,'-')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
  ...
  <xsl:template mode="date-format" name="date:format-julian-day">
  ...
  <xsl:template mode="date-format" name="date:calculate-week-number">
    <xsl:param name="year"/>
    <xsl:param name="month"/>
    <xsl:param name="day"/>
...
<xsl:template mode="date-format" name="date:last-day-of-month">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="year" select="substring-before($date,'-')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
...
<xsl:template mode="date-format" name="date:julian-day-to-absolute-day">
	<xsl:param name="j-day"/>
	<xsl:value-of select="$j-day - 1721425"/>
</xsl:template>

<xsl:template mode="date-format" name="date:absolute-day-to-julian-day">
	<xsl:param name="abs-day"/>
	<xsl:value-of select="$abs-day + 1721425"/>
</xsl:template>

<xsl:template mode="date-format" name="date:date-to-absolute-day">
    <xsl:param name="date-time"/>
    <xsl:param name="date" select="substring-before($date-time,'T')"/>
    <xsl:param name="year" select="substring-before($date,'-')"/>
    <xsl:param name="month" select="substring-before(substring-after($date,'-'),'-')"/>
...
<xsl:template mode="date-format" name="date:absolute-day-to-date">
  <xsl:param name="abs-day"/>
...
<xsl:template mode="date-format" name="date:k-day-on-or-before-abs-day">
	<xsl:param name="abs-day"/>
	<xsl:param name="k"/>
	<xsl:value-of select="$abs-day - (($abs-day - $k) mod 7)"/>
</xsl:template>

<xsl:template mode="date-format" name="date:iso-date-to-absolute-day">
...
<xsl:template mode="date-format" name="date:absolute-day-to-iso-date">
	<xsl:param name="abs-day"/>
...
<xsl:template mode="date-format" name="date:last-day-of-julian-month">
	<xsl:param name="month"/>
	<xsl:param name="year"/>
	<xsl:choose>
...
<xsl:template mode="date-format" name="date:julian-date-to-absolute-day">
    <xsl:param name="year"/>
    <xsl:param name="month"/>
    <xsl:param name="day"/>
...
<xsl:template mode="date-format" name="date:julian-day-to-julian-date">
	<xsl:param name="j-day"/>
...
<xsl:template mode="date-format" name="date:julian-day-to-date">
	<xsl:param name="j-day"/>
...
<xsl:template mode="date-format" name="date:julian-or-gregorian-date-elem">
	<xsl:param name="b"/>
	<xsl:param name="c"/>
...
<xsl:template mode="date-format" name="date:last-day-of-islamic-month">
	<xsl:param name="month"/>
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:islamic-date-to-absolute-day">
    <xsl:param name="year"/>
    <xsl:param name="month"/>
    <xsl:param name="day"/>
...
<xsl:template mode="date-format" name="date:absolute-day-to-islamic-date">
    <xsl:param name="abs-day"/>
...
<xsl:template mode="date-format" name="date:last-month-of-hebrew-year">
	<xsl:param name="year"/>
	<xsl:choose>
...
<xsl:template mode="date-format" name="date:hebrew-calendar-ellapsed-days">
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:days-in-hebrew-year">
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:long-heshvan">
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:short-kislev">
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:last-day-of-hebrew-month">
	<xsl:param name="month"/>
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:sum-last-day-in-hebrew-months">
       <xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:hebrew-date-to-absolute-day">
    <xsl:param name="year"/>
    <xsl:param name="month"/>
    <xsl:param name="day"/>
...
<xsl:template mode="date-format" name="date:fixup-hebrew-year">
...
<xsl:template mode="date-format" name="date:fixup-hebrew-month">
	<xsl:param name="year"/>
...
<xsl:template mode="date-format" name="date:absolute-day-to-hebrew-date">
    <xsl:param name="abs-day"/>
...
<xsl:template mode="date-format" name="date:independence-day">
	<xsl:param name="year"/>
	<xsl:call-template name="date:date-to-absolute-day">
		<xsl:with-param name="month" select="7"/>
		<xsl:with-param name="day" select="4"/>
...
<xsl:template mode="date-format" name="date:n-th-k-day">
...
<xsl:template mode="date-format" name="date:calculate-julian-day">
	<xsl:param name="year"/>
	<xsl:param name="month"/>
	<xsl:param name="day"/>
...
<xsl:template mode="date-format" name="date:date-difference">
...
<xsl:template mode="date-format" name="date:julian-day-to-gregorian-date">
	<xsl:param name="j-day"/>
...
<xsl:template mode="date-format" match="/xsl:stylesheet[@id = 'date:date-time']" priority="-1000">
<results>
<!--
	<result>
	<xsl:call-template name="date:julian-day-to-date">
