...
<!-- generated by dexter from `profile-test.html'  -->
						...
						</xsl:text><xsl:element name="div"><xsl:attribute name="id"><xsl:text>title</xsl:text></xsl:attribute><xsl:element name="h2"><xsl:attribute name="align">center</xsl:attribute><xsl:attribute name="class">title</xsl:attribute><xsl:choose><xsl:when test=".//Member/First/text() and .//Member/Last/text()"><xsl:text/><xsl:value-of select=".//Member/First"/><xsl:text><![CDATA[ ]]></xsl:text><xsl:value-of select=".//Member/Last"/></xsl:when><xsl:otherwise><xsl:text/></xsl:otherwise></xsl:choose></xsl:element></xsl:element><xsl:text>
								...
								</xsl:text><xsl:element name="li"><xsl:attribute name="class">first</xsl:attribute><xsl:element name="a"><xsl:attribute name="accesskey">1</xsl:attribute><xsl:attribute name="href">#</xsl:attribute><xsl:attribute name="title"/><xsl:text>Resume</xsl:text></xsl:element></xsl:element><xsl:text>
								</xsl:text><xsl:element name="li"><xsl:element name="a"><xsl:attribute name="accesskey">2</xsl:attribute><xsl:attribute name="href">#</xsl:attribute><xsl:attribute name="title"/><xsl:text>Resume Builder</xsl:text></xsl:element></xsl:element><xsl:text>
								</xsl:text><xsl:element name="li"><xsl:element name="a"><xsl:attribute name="accesskey">3</xsl:attribute><xsl:attribute name="href">#</xsl:attribute><xsl:attribute name="title"/><xsl:text>Friends</xsl:text></xsl:element></xsl:element><xsl:text>
								</xsl:text><xsl:element name="li"><xsl:element name="a"><xsl:attribute name="accesskey">4</xsl:attribute><xsl:attribute name="href">#</xsl:attribute><xsl:attribute name="title"/><xsl:text>Email</xsl:text></xsl:element></xsl:element><xsl:text>
							</xsl:text></xsl:element><xsl:text>
						</xsl:text></xsl:element><xsl:text>
								...
								</xsl:text><xsl:for-each select="result/Skills/*"><xsl:variable name="DexterDepthLevel1"><xsl:value-of select="position()"/></xsl:variable><xsl:element name="div"><xsl:attribute name="class">CoreCompet floatleft</xsl:attribute><xsl:value-of select="topic"/></xsl:element></xsl:for-each><xsl:text>
								</xsl:text><xsl:text>
								</xsl:text><xsl:text>
								</xsl:text><xsl:text>
								</xsl:text><xsl:text>
							...
							</xsl:text><xsl:element name="div"><xsl:attribute name="class">resumeSectionTitle</xsl:attribute><xsl:choose><xsl:when test="experienceType/text()"><xsl:text/><xsl:value-of select="experienceType"/><xsl:text><![CDATA[ Experience]]></xsl:text></xsl:when><xsl:otherwise><xsl:text/></xsl:otherwise></xsl:choose></xsl:element><xsl:text>
							</xsl:text><xsl:element name="div"><xsl:attribute name="id"><xsl:text>resumeProfExperience</xsl:text><xsl:text>-</xsl:text><xsl:value-of select="$DexterDepthLevel1"/></xsl:attribute><xsl:text>
								...
								I have a job</xsl:text><xsl:element name="br"/><xsl:text>
										...
										</xsl:text><xsl:element name="li"><xsl:text>Held office of president. We helped women break into the IT world through networking and education.</xsl:text></xsl:element><xsl:text>
									</xsl:text></xsl:element><xsl:text>
								</xsl:text></xsl:element><xsl:text>
							</xsl:text></xsl:element><xsl:text>
						</xsl:text></xsl:element><xsl:text>
										...
										</xsl:text><xsl:element name="li"><xsl:text>Taught various web and design technologies including: PHP, MySQL, Perl, Flash/Actionscript, Javascript, DHTML, CSS, and HTML</xsl:text></xsl:element><xsl:text>
									</xsl:text></xsl:element><xsl:text>
								</xsl:text></xsl:element><xsl:text>
							</xsl:text></xsl:element><xsl:text>
						</xsl:text></xsl:element><xsl:text>
